...
from core.constants import SPACESHIP_WIDTH, SPACESHIP_HEIGHT, WIDTH, HEIGHT, FPS, YELLOW, RED
...
class GalaxyEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        if render_mode == "human":
            ...
            self.yellow_ship = Spaceship(100, HEIGHT//2, pygame.image.load("assets/spaceship_yellow.png"))
            self.yellow_ship.image = pygame.transform.rotate(pygame.transform.scale(self.yellow_ship.image, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)
            self.red_ship = Spaceship(WIDTH-100, HEIGHT//2, pygame.image.load("assets/spaceship_red.png"))
            self.red_ship.image = pygame.transform.rotate(pygame.transform.scale(self.red_ship.image, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 270)
        else:
